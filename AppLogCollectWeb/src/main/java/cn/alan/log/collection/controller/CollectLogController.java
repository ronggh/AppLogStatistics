package cn.alan.log.collection.controller;

import cn.alan.common.model.*;
...
import static cn.alan.common.model.Constants.KAFKA_SERVER;
...
public class CollectLogController {
    ...
    private void processIp(AppLogEntity e, HttpServletRequest req) {
        ...
        if (geoInfo == null) {
            ...
            //System.out.println("Country:" + GeoUtil.getCountry(clientIP));
            // 缓存数据
